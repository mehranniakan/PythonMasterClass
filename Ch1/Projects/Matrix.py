...
def get_user_input(count):
    if count == 1:
        user_input = list(map(int, input(f'Enter {count}st row of matrix :').split()))
    elif count == 2:
        user_input = list(map(int, input(f'Enter {count}nd row of matrix :').split()))
    else:
        user_input = list(map(int, input(f'Enter {count}th row of matrix :').split()))
